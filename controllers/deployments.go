...
func (r *DemoServicesReconciler) manageDeployment(instance *grpcdemov1.DemoServices, srv grpcdemov1.Service, reqLogger logr.Logger) error {
...
func (r *DemoServicesReconciler) deleteOrphanedDeployments(instance *grpcdemov1.DemoServices, reqLogger logr.Logger) error {
...
func newDeployment(srv grpcdemov1.Service, cr *grpcdemov1.DemoServices) *appsv1.Deployment {
